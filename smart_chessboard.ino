...
void find_moves(int row, int col){
    ...
    switch (ch_ext[row][col]) {
        case PAWN|BLACK:
        case PAWN|WHITE:
			//player2 is the player on top (color doesn't matter)
			if(PIECE_IS(player2, row, col)) direction = 1;						//player2's pawns can only eat and move downward, player1's pawns can only eat and move upward
